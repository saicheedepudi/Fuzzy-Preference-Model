        ...
        <div id="templatemo_content_area">
        	<div id="templatemo_left_section">
            	...
            	<div class="templatemo_section_1">
                    ...
                    <h1>User Menu </h1>
					 <ul class="sb_menu">
          <li><a href="user_Profile.jsp"><span>My Profile</span></a></li>
		  <li><a href="user_SearchPost.jsp"><span>Search Post by Content Keyword</span></a></li>
		  <li><a href="user_ViewTopRecommendation.jsp"><span>View top 'K' Recommendation</span></a></li>
		  <li><a href="user_RecommendedPosts.jsp"><span>View All Recommended Posts </span></a></li>
          <li><a href="user_SearchHistory.jsp"><span>My Search History </span></a></li>
