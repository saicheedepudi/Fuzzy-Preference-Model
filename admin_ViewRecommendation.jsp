	...
	<div id="templatemo_container">    
        ...
        <div id="templatemo_content_area">
          ...
          <div id="templatemo_right_section">
                ...
                <h1>All Recommendations on Post <span class="style10"><%=request.getParameter("p_Name")%></span></h1>
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
				 				<tr >
								  ...
								  <div align="center" class="style9"><span class="style17" style="color:#f69722">Post Name</span> </div></td>
								    <td><div align="center" class="style13"><span class="style17" style="color:#000000;"><%= p_Name%></span></div></td>
		  						<tr/>
				    
				    
				    			<tr>
									<td width="187" height="27">
						  		  <div align="center" class="style9"><span class="style17" style="color:#f69722">Categorie</span> </div></td>
								    <td><div align="center" class="style13"><span class="style17" style="color:#000000;"><%= categorie%></span></div></td>
								</tr>
								<tr>
									<td width="187" height="27">
								  <div align="center" class="style9"><span class="style17" style="color:#f69722">Rank </span> </div></td>
								    <td><div align="center" class="style13"><span class="style17" style="color:#000000;"><%= p_Rank%></span></div></td>
				    			</tr>
								<tr>
										<td width="187" height="27">
								  <div align="center" class="style9"><span class="style17" style="color:#f69722">Description </span></div></td>
								        <td><div align="center" class="style13"><span class="style17" style="color:#000000;"><%= p_Desc1%></span></div></td>
								</tr>
								<tr>
       <tr>
     <td  width="160" height="41" valign="middle" class="style12" style="color: #2c83b0;"><div align="left " class="style8 style15 style9 style12" style="margin-left:20px;">Recommended By</div></td>
     <td  width="187" height="41" valign="middle" class="style12" style="color: #2c83b0;" columnspan="2"><div align="left " class="style8 style15 style9 style12" style="margin-left:20px;">Recommended Details</div></td>
	  <td  width="140" height="41" valign="middle" class="style12" style="color: #2c83b0;" columnspan="2"><div align="left " class="style8 style15 style12 style9" style="margin-left:20px;">Date</div></td>
   </tr>
   <%
	...
	while ( rs1.next() )
     ...
     <td height="30"><div align="center" class="style19 style20 style13 style14"><%=rec_By%></div></td>
	  <td><div align="center" class="style21 style13 style14"><%=rec_Details%></div></td>
	   <td><div align="center" class="style21 style13 style14"><%=rec_date%></div></td>
   </tr>
    ...
    <%
       	...
       	out.println("");
						...
						{
						%><p class=" style9">No Recommendations Found on Post<span class="style12"> <%=p_Name%></span></p>
						<%
						}
                ...
                <p>&nbsp;</p>
                <p>&nbsp;</p>
				<div align="right" class="style7"><a href="admin_AllRecommendation.jsp">Back</a></div>
                <p>&nbsp;</p>
                <p></p>
          </div><!-- End Of Right -->
