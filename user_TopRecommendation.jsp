	...
	<div id="templatemo_container">    
        ...
        <div id="templatemo_content_area">
          ...
          <div id="templatemo_right_section">
                ...
                <h1>Top Recommendation post <span class="style18"><%=request.getParameter("p_Name")%></span> Details</h1>
                <p class="style6">&nbsp;</p>
                <p>
    <%
      	try 
   ...
   <%
    ...
    <%
       	...
       	out.println("");
                ...
                <p>&nbsp;</p>
                <div class="style11">
                  <div align="right"><a href="user_ViewTopRecommendation.jsp">Back</a></div>
                </div>
          </div>
          <!-- End Of Right -->
