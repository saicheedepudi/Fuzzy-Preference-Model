	...
	<div id="templatemo_container">    
        ...
        <div id="templatemo_content_area">
          ...
          <div id="templatemo_right_section">
                ...
                <h1>End User Login  Page</h1>
              <p>&nbsp;</p>
                <p><form action="authentication.jsp?type=<%="user"%>" method="post" id="leavereply">
        	<p>&nbsp;</p>
        	<p>&nbsp;</p>
        	<table width="313" border="0" align="center">
              <tr>
                <td width="140" height="30"><div align="center" class="style13 style2 style4"> User Name </div></td>
                <td width="163"><div align="center"><input type="text" name="userid" /></div></td>
              </tr>
              <tr>
                <td height="35"><div align="center" class="style13 style2 style4">Password</div></td>
			...
			<p>&nbsp;</p>
			<div align="right" class="style5">New <a href="user_Register.jsp">Register</a> </div>
			<p>&nbsp;</p>
